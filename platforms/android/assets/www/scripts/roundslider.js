...
(function ($, window, undefined) {
    ...
    RoundSlider.prototype = {
        ...
        _render: function () {
            ...
            this.block = createElement("div.rs-block");
        ...
        _appendOverlay: function () {
            ...
            if (shape == "pie") {
                this._checkOverlay(".rs-overlay", 205);
                this._checkOverlay(".rs-overlay-copy", 270);
            }
        ...
        _updateStartEnd: function () {
            ...
            if (circle != "full") {
                ...
                else if (circle == "pie") this.options.endAngle = "+200";
        ...
        for (var i = 0; i < this.length; i++) {
            ...
            if (!instance) {
                ...
                if (typeof instance[options] === "function") {
					var startWith = (options.substring( 0, "get".length ) === "get");
                    if ((options == "option" || startWith) && args[2] === undefined) {
